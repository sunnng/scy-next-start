...
export function SignInForm() {
	return (
		<Card className="rounded-none pt-8">
			<CardHeader>
				<CardTitle className="text-lg md:text-xl">用户登录</CardTitle>
				<CardDescription className="text-xs md:text-sm">请输入您的电子邮箱</CardDescription>
			</CardHeader>
			<CardContent>
				<form>
					<div className="flex flex-col gap-6">
						...
						<div className={cn("flex w-full items-center gap-2", "flex-col justify-between")}>
							<Button variant="outline" className={cn("w-full gap-2")} onClick={async () => {}}>
